...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/school_walli_mastii'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/harshparmar0/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/harshparmar0/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/school_walli_mastii'),     
        ],
        [
